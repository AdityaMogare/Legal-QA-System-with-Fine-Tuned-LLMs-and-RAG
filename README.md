...
**🌐 Live Web Application**: Access the system through a modern React frontend with FastAPI backend, connecting to the [JurisPrae model](https://huggingface.co/AdityaMogare/LurisQA) on Hugging Face.
